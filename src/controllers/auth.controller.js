// controllers/microsoftAuth.controller.js
import jwt from "jsonwebtoken";
import User from "../models/user.js";
import MicrosoftAuthHelper from "../helpers/microsoftAuthHelper.js";
...
export async function handleMicrosoftCallback(req, res) {
  try {
    ...
    const { user } = await MicrosoftAuthHelper.handleMicrosoftAuth(
      code,
      codeVerifier
    );
